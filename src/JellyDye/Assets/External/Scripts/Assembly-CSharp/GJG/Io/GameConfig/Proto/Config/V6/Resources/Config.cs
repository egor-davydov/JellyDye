...
namespace Gjg.Io.GameConfig.Proto.Config.V6.Resources
{
	public sealed class Config : IMessage<Config>, IMessage, IEquatable<Config>, IDeepCloneable<Config>, IBufferMessage
	{
		...
		private static readonly FieldCodec<Threshold> _repeated_thresholds_codec;

		private readonly RepeatedField<Threshold> thresholds_;
		...
		[DebuggerNonUserCode]
		public RepeatedField<Threshold> Thresholds => null;
