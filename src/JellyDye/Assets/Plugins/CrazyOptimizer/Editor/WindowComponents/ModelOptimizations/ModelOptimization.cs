      ...
      if (_multiColumnHeaderState == null)
        _multiColumnHeaderState = new MultiColumnHeaderState(
          new[]
          {
            ...
            {
              headerContent = new GUIContent() { text = "Model" },
              width = 150,
              minWidth = 150,
              canSort = true,
            },
            new MultiColumnHeaderState.Column()
            {
              headerContent = new GUIContent() { text = "R/W enabled" },
              width = 80,
              minWidth = 80,
              canSort = true,
            },
            new MultiColumnHeaderState.Column()
            {
              headerContent = new GUIContent() { text = "Polygons optimized" },
              width = 120,
              minWidth = 120,
              canSort = true,
            },
            new MultiColumnHeaderState.Column()
            {
              headerContent = new GUIContent() { text = "Vertices optimized" },
              width = 120,
              minWidth = 120,
              canSort = true,
            },
            new MultiColumnHeaderState.Column()
            {
              headerContent = new GUIContent() { text = "Mesh compression" },
              width = 120,
              minWidth = 120,
              canSort = true,
            },
            new MultiColumnHeaderState.Column()
            {
              headerContent = new GUIContent() { text = "Animation compression" },
              width = 140,
              minWidth = 140,
              canSort = true,
            },
