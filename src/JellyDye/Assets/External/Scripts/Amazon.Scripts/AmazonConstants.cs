public static class AmazonConstants
{
	...
	public const string RELEASE_NOTES_URL = "https://ams.amazon.com/webpublisher/uam/docs/aps-mobile/resources";

	public const string titleAboutDialog = "About Amazon SDK";

	public const string labelSdkVersion = "Amazon SDK version 1.5.0";
