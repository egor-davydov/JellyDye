  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_2_d.xyz = u_xlat16_2_d.xyz + in_f.texcoord3.xyz;
          ...
          u_xlat10_1 = texture2D(_MainTex, in_f.texcoord2.xy);
          
          u_xlat1_d = u_xlat10_1 * _Color;
          
          u_xlat4.xyz = u_xlat1_d.xyz * u_xlat4.xyz;
          
          u_xlat16_2_d.xyz = u_xlat1_d.xyz * _LightColor0.xyz;
          
          u_xlat16_2_d.xyz = u_xlat16_2_d.xyz * u_xlat3.xyz + u_xlat4.xyz;
          
          u_xlat1_d.xyz = u_xlat0_d.xyz * _SpecularColor.xyz + u_xlat16_2_d.xyz;
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_2 = texture2D(_MainTex, in_f.texcoord2.xy);
          
          u_xlat2_d = u_xlat10_2 * _Color;
          
          u_xlat16_3.xyz = u_xlat2_d.xyz * _LightColor0.xyz;
          
          u_xlat2_d.xyz = u_xlat16_3.xyz * u_xlat1_d.xyz + u_xlat0_d.xyz;
