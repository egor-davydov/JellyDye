...
namespace CrazyGames
{
  ...
  public class CrazySettings : ScriptableObject
  {
    ...
    [Header("User account testing (editor only)")] [Tooltip("Select the response you want to receive when calling CrazyUser.Instance.IsUserAccountAvailable")]
    ...
    [Header("Other settings (editor only)")] [Tooltip("You can disable the SDK logs in the editor if you find them annoying. Some important logs will still be displayed.")]
