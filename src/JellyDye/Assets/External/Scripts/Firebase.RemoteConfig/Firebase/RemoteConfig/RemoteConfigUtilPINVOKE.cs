...
namespace Firebase.RemoteConfig
{
	internal class RemoteConfigUtilPINVOKE
	{
		...
		[PreserveSig]
		public static extern int ConfigInfo_LastFetchStatus_get(HandleRef jarg1);

		[PreserveSig]
		public static extern int ConfigInfo_LastFetchFailureReason_get(HandleRef jarg1);

		[PreserveSig]
		public static extern void delete_ConfigInfo(HandleRef jarg1);
