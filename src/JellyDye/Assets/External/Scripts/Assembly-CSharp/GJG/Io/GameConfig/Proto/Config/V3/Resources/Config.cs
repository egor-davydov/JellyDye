...
using Gjg.Io.GameConfig.Proto.Stepback.V1.Resources;
...
namespace Gjg.Io.GameConfig.Proto.Config.V3.Resources
{
	public sealed class Config : IMessage<Config>, IMessage, IEquatable<Config>, IDeepCloneable<Config>, IBufferMessage
	{
		...
		private Gjg.Io.GameConfig.Proto.Stepback.V1.Resources.Config stepback_;
		...
		[DebuggerNonUserCode]
		public Gjg.Io.GameConfig.Proto.Stepback.V1.Resources.Config Stepback
		{
			get
			{
				return null;
