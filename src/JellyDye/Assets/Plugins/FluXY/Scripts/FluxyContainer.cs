...
namespace Fluxy
{
  ...
  public class FluxyContainer : MonoBehaviour
  {
    ...
    {
      [Min(0)] public float densityEdgeWidth;
      [Min(0)] public float densityFalloffRate;
      [Min(0)] public float velocityEdgeWidth;
      [Min(0)] public float velocityFalloffRate;
    ...
    /// </summary>
    [Tooltip("Amount of subdivisions in the plane mesh.")] public Vector2Int subdivisions = Vector2Int.one;
    ...
    /// </summary>
    [Tooltip("Size of the container in local space.")] public Vector3 size = Vector3.one;
    ...
    /// </summary>
    [Tooltip("Color used to tint the clear texture.")] public Color clearColor;
    ...
    /// </summary>
    [Tooltip("Tiling of surface normal map.")] public Vector2 normalTiling = Vector2.one;

    /// <summary>
    /// Intensity of the surface normals.
    /// </summary>
    [Range(0, 1)] [Tooltip("Intensity of the surface normals.")]
    ...
    /// </summary>
    [Range(0, 1)] [Tooltip("Scale (0%-100%) of container's velocity. If set to zero, containers will be regarded as static.")]
    ...
    /// </summary>
    [Range(0, 1)] [Tooltip("Scale (0%-100%) of container's acceleration. This controls how much world-space inertia affects the fluid.")]
    ...
    /// </summary>
    [Tooltip("World-space gravity applied to the fluid.")] public Vector3 gravity = Vector3.zero;
    ...
    /// </summary>
    [Tooltip("Lightsource used for volume rendering.")] public Light lightSource = null;
    ...
    /// </summary>
    [Range(0, 1)] [Tooltip("Scales fluid pressure.")] public float pressure = 1;

    /// <summary>
    /// Scales fluid viscosity.
    /// </summary>
    [Range(0, 1)] [Tooltip("Scales fluid viscosity.")] public float viscosity = 0;
    ...
    /// </summary>
    [Range(0, 1)] [Tooltip("Amount of adhesion to the container's surface.")]
    public float adhesion = 0;

    /// <summary>
    /// Amount of surface tension. Higher values will make the fluid tend to form round shapes.
    /// </summary>
    [Range(0, 1)] [Tooltip("Amount of surface tension. Higher values will make the fluid tend to form round shapes.")]
    ...
    /// </summary>
    [Tooltip("Amount of density dissipated per second.")] public Vector4 dissipation = Vector4.zero; // rate at which state channels decrease.
    ...
    public virtual void UpdateContainerShape()
    {
      ...
      {
        case ContainerShape.Plane:
          BuildPlaneMesh();
          break;
        case ContainerShape.Volume:
          BuildVolumeMesh();
          break;
